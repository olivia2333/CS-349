...
public class Head extends Sprite{
    ...
    public Head(double start_x, double start_y, int width, int height){
        super();
    ...
    private void initialize(double start_x, double start_y, double width, double height){
        ...
        w = width;
        h = height;
        pivot = new Point2D(x + w/2, y + h);
        initial_pivot = new Point2D(x + w/2, y + h);
        image = new Image("head.png");
    }
